...
crossoverProbabilities = [0.05, 0.1, 0.2, 0.3, 0.5, 0.6, 0.8, 1.0]
mutationProbabilities = [0.01, 0.05, 0.1, 0.25, 0.4, 0.6, 0.75, 0.9]
...
bounds = [(-5, 5)]
populationSize = 100
numOfInterations = 100
tolerances = [0.01, 0.02, 0.05, 0.1]
recombinationRates = [0.5, 0.6, 0.8, 1.0]
mutationRates = [(0.5, 1), (0.75, 1), (0.5, 1.5), (0.75, 1.5)]
res = []
...
for tolerance in tolerances:
  for recombination in recombinationRates:
    for mutation in mutationRates:
      ...
      # Add to the list
      res.append([solution.fun, populationSize, numOfInterations, tolerance, recombination, mutation])
res.sort()
print(res[:10])
...
# Define parameters
optionsList = [{'c1': 1.0, 'c2': 1.0, 'w': 0.15}, {'c1': 1.0, 'c2': 0.5, 'w': 0.15}, {'c1': 0.5, 'c2': 1.0, 'w': 0.15}, {'c1': 0.5, 'c2': 1.0, 'w': 0.25}, {'c1': 0.5, 'c2': 0.5, 'w': 0.15}, {'c1': 1.0, 'c2': 1.0, 'w': 0.25}]
numsOfParticles = [10, 25, 50, 80, 100, 200]
numsOfEvaluations = 10000
...
for options in optionsList:
  for particles in numsOfParticles:
    ...
    # Get the cost
    cost, _ = optimizer.optimize(sum_of_different_powers, iters=numsOfEvaluations // particles)

    # Add to the list
    res.append([cost, options, particles])
...
for options in optionsList:
  for particles in numsOfParticles:
    ...
    # Get the cost
    cost, _ = optimizer.optimize(zakharov_function, iters=numsOfEvaluations // particles)
...
for options in optionsList:
  for particles in numsOfParticles:
    ...
    # Get the cost
    cost, _ = optimizer.optimize(griewank_function, iters=numsOfEvaluations//particles)
...
# Define parameters
optionsList = [{'c1': 1.0, 'c2': 1.0, 'w': 0.15}, {'c1': 1.0, 'c2': 0.5, 'w': 0.15}, {'c1': 0.5, 'c2': 1.0, 'w': 0.15}, {'c1': 0.5, 'c2': 1.0, 'w': 0.25}, {'c1': 0.5, 'c2': 0.5, 'w': 0.15}, {'c1': 1.0, 'c2': 1.0, 'w': 0.25}]
numsOfParticles = [1, 10, 25, 50, 100, 125]
numsOfEvaluations = 2500
...
for options in optionsList:
  for particles in numsOfParticles:
    ...
    # Get the cost
    cost, _ = optimizer.optimize(schwefel, iters=numsOfEvaluations//particles)
...
for options in optionsList:
  for particles in numsOfParticles:
    ...
    # Get the cost
    cost, _ = optimizer.optimize(rastrigin, iters=numsOfEvaluations//particles)
...
for options in optionsList:
  for particles in numsOfParticles:
    ...
    # Get the cost
    cost, _ = optimizer.optimize(sphere, iters=numsOfEvaluations//particles)
...
for options in optionsList:
  for particles in numsOfParticles:
    ...
    # Get the cost
    cost, _ = optimizer.optimize(sum_squares, iters=numsOfEvaluations//particles)
...
def trid(arr):
  res = np.sum([(xi - 1) ** 2 for xi in arr]) - np.sum([arr[i] * arr[i - 1] for i in range(1, len(arr))])
  return res if res >= 0.0 else float("inf")
...
for options in optionsList:
  for particles in numsOfParticles:
    ...
    # Get the cost
    cost, _ = optimizer.optimize(trid, iters=numsOfEvaluations//particles)
...
for options in optionsList:
  for particles in numsOfParticles:
    ...
    # Get the cost
    cost, _ = optimizer.optimize(booth, iters=numsOfEvaluations//particles)
...
for options in optionsList:
  for particles in numsOfParticles:
    ...
    # Get the cost
    cost, _ = optimizer.optimize(michalewicz, iters=numsOfEvaluations//particles)
...
for options in optionsList:
  for particles in numsOfParticles:
    ...
    # Get the cost
    cost, _ = optimizer.optimize(matyas, iters=numsOfEvaluations//particles)
...
for options in optionsList:
  for particles in numsOfParticles:
    ...
    # Get the cost
    cost, _ = optimizer.optimize(mccormick, iters=numsOfEvaluations//particles)
...
for options in optionsList:
  for particles in numsOfParticles:
    ...
    # Get the cost
    cost, _ = optimizer.optimize(cross_in_tray, iters=numsOfEvaluations//particles)
...
for options in optionsList:
  for particles in numsOfParticles:
    ...
    # Get the cost
    cost, _ = optimizer.optimize(drop_wave, iters=numsOfEvaluations//particles)
...
for options in optionsList:
  for particles in numsOfParticles:
    ...
    # Get the cost
    cost, _ = optimizer.optimize(holder_table, iters=numsOfEvaluations//particles)
